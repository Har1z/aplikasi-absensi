    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 mb-2">
                <div>
                    <h4 class="fw-bold">TAMBAHKAN DATA SISWA</h4>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-4 mb-3">
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <input type="text" class="form-control" id="nisnInput" name="nisn" minlength="10" required >
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="noHpOrtuInput" name="noHpOrtu" required >
                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-8">
                                                    ...
                                                    <select class="form-select" aria-label="Default select example" id="jurusanInput" name="jurusan" >
                                                        <option value="Kecantikan">Tata Kecantikan</option>
