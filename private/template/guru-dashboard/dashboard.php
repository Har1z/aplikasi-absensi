            ...
            <div class="col">
                <div class="card" style="user-select: none;">
                    <a href="?tab=kelola-pesan">
                        <div class="card-body kelola-pesan" onclick="click()">
                            <svg xmlns="http://www.w3.org/2000/svg" class="kelola-pesan-icon" viewBox="0 0 24 24"
                                style="fill: rgba(255, 255, 255, 1);">
                            ...
                            <h6 class="card-subtitle mb-2">atur pesan yang dikirimkan ke wali murid</h6>
                        </div>
                    </a>
                </div>
            </div>
