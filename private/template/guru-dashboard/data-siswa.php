    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-3 mb-4">
                <div>
                    <a type="button" href="?tab=tambah-data-siswa" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(255, 255, 255, 1);transform: ;msFilter:;"><path d="M19 11h-6V5h-2v6H5v2h6v6h2v-6h6z"></path></svg> Tambah data siswa</a>
                </div>
            </div>
                                        ...
                                        ?>
                                                    <tr>
                                                            ...
                                                            <td class="user-select-none text-center">
                                                                ...
                                                                <a class="btn btn-success mt-3" href="../resources/images/QRcode/<?= $data['nama'] ?>-QR.png" download="<?= $data['nama'].'_'.$data['kelas'].'-'.$data['jurusan'].'.png' ?>" > Download All </a>
                                                            </td>
                                                        </tr>
                                        <?php
                                                $nomor++;
